...
alias gopermission='cd $CEDAR_HOME/cedar-permission-server'
...
alias gopermissionplay='gopermission && cd cedar-permission-server-play'
...
alias startpermission='gopermission && mp2r &'
alias killpermission='gopermissionplay && killbypid'
