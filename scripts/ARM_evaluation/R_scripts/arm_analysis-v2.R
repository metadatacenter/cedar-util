...
file_NCBItoNCBI_annotated_allpopulatedsets_mappings <- paste(workspace, "/free_text/", sep="")
file_NCBItoEBI_annotated_allpopulatedsets_mappings <- paste(workspace, "/free_text/", sep="")
file_EBItoEBI_annotated_allpopulatedsets_mappings <- paste(workspace, "/free_text/", sep="")
file_EBItoNCBI_annotated_allpopulatedsets_mappings <- paste(workspace, "/free_text/", sep="")
...
generate_all_plots_2 <- function(evaluation_set1, evaluation_set2, reciprocal_rank_vr_column, reciprocal_rank_baseline_column) {
  ...
  data_p1_1 <- aggregate_data_1_2(data_NCBItoNCBI1, reciprocal_rank_vr_column, reciprocal_rank_baseline_column, recom_method_name="recommender", baseline_method_name="baseline")
  data_p1_2 <- aggregate_data_1_2(data_NCBItoNCBI2, reciprocal_rank_vr_column, reciprocal_rank_baseline_column, recom_method_name="recommender_annotated", baseline_method_name="baseline_annotated")
  data_p1 <- rbind(data_p1_1, data_p1_2)
  
  p1 <- generate_plot(data_p1, "Training: NCBI; Testing: NCBI")
...
evaluation_set_3 <- new("EvaluationSet", datasets=c(file_NCBItoNCBI_annotated_allpopulatedsets_mappings, file_NCBItoEBI_annotated_allpopulatedsets_mappings, 
...
evaluation_sets = c(evaluation_set_1, evaluation_set_2)
...
for (evaluation_set in evaluation_sets) {
  generate_all_plots_2(evaluation_set, 'RR_top5_vr', 'RR_top5_baseline')
}
