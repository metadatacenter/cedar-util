...
OUTPUT_PATH = INPUT_PATH + "/updated"
...
SCHEMA_IS_BASED_ON = "https://repo.metadatacenter.orgx/templates/f1d0c702-70df-4b49-ba24-e0f9ce4ae3a6"  # It must exist in the target system
PAV_CREATED_ON = "2017-08-09T20:54:50-0700"
PAV_CREATED_BY = "https://metadatacenter.org/users/8d787b98-33dd-4aff-a88c-440caf452c61"  # It must exist in the target system
PAV_LAST_UPDATED_ON = "2017-08-09T20:54:50-0700"
...
FOLDER_ID = "https://repo.metadatacenter.orgx/folders/05b68139-edfd-445e-89a2-892c3a860332"
API_KEY = "069485f648af13ee16610f8104e445ab835422c3977b85b97dcb94e950127c09"
    ...
    if OPTIONAL_ATT_FIELD in old_instance:
        for att in old_instance[OPTIONAL_ATT_FIELD]:
            if OPTIONAL_ATT_NAME_FIELD in att and OPTIONAL_ATT_VALUE_FIELD in att:
                ...
                if VALUE_LABEL_FIELD in att[OPTIONAL_ATT_NAME_FIELD]:
                    new_optional_att[OPTIONAL_ATT_NAME_FIELD][ID_FIELD] = att[OPTIONAL_ATT_NAME_FIELD][VALUE_FIELD]
                    new_optional_att[OPTIONAL_ATT_NAME_FIELD][VALUE_LABEL_FIELD] = att[OPTIONAL_ATT_NAME_FIELD][
                        VALUE_LABEL_FIELD]
                ...
                if VALUE_LABEL_FIELD in att[OPTIONAL_ATT_VALUE_FIELD]:
                    new_optional_att[OPTIONAL_ATT_VALUE_FIELD][ID_FIELD] = att[OPTIONAL_ATT_VALUE_FIELD][VALUE_FIELD]
                    new_optional_att[OPTIONAL_ATT_VALUE_FIELD][VALUE_LABEL_FIELD] = att[OPTIONAL_ATT_VALUE_FIELD][
                        VALUE_LABEL_FIELD]
...
def update_instance_field_controlled(field_name, old_instance, new_instance):
    if (field_name in old_instance) and (VALUE_FIELD in old_instance[field_name]):
        if (old_instance[field_name][VALUE_FIELD] is not None) and (
            ...
            new_instance[field_name][VALUE_LABEL_FIELD] = old_instance[field_name][VALUE_LABEL_FIELD]
            # else: do nothing
    return new_instance
