...
class RemoveSchemaDescriptionFromPropertiesPatch(object):

    def __init__(self):
        self.description = "Removes the schema:description in the properties of a template field or element"
    ...
    def get_patch(error_message, doc=None):
        ...
        {
            "op": "replace",
            "value": [item for item in required_list if item != "schema:description"],
