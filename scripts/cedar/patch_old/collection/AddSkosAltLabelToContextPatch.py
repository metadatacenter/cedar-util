...
class AddSkosAltLabelToContextPatch(object):

    def __init__(self):
        self.description = "Fixes the missing skos:altLabel in the @context object of a template-field"
